...
import com.qht.aiemail.service.LoginService;
import com.qht.aiemail.service.SystemConfigService;
import com.qht.aiemail.util.SystemJwtTokenHolder;
...
/**
 * Implementation that calls QHT Clinic login API
...
public class LoginServiceImpl implements LoginService {
    ...
    private Mono<String> loginAndRefreshToken() {
        ...
        String baseUrl = configService.getRequired("QHT_BASE_URL");
        String loginUrl = configService.getRequired("QHT_LOGIN_URL");
        String username = configService.getRequired("QHT_LOGIN_USERNAME");
        String password = configService.getRequired("QHT_LOGIN_PASSWORD");
