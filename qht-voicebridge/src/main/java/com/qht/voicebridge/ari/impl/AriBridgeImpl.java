package com.qht.voicebridge.ari.impl;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.qht.voicebridge.ari.ExternalMediaManager;
import com.qht.voicebridge.ai.AiClientFactory;
import com.qht.voicebridge.ai.BotClient;
import com.qht.voicebridge.ai.TruncateManagerFactory;
import com.qht.voicebridge.audio.AudioCodec;
import com.qht.voicebridge.audio.CodecFactory;
import com.qht.voicebridge.audio.resampler.AudioTranscoder;
import com.qht.voicebridge.billing.CallBillingInfo;
import com.qht.voicebridge.ivr.IvrService;
import com.qht.voicebridge.models.StasisAppConfig;
import com.qht.voicebridge.queue.PlayoutScheduler;
import com.qht.voicebridge.recording.CallRecordingManager;
import com.qht.voicebridge.recording.StereoWavFileWriter;
import com.qht.voicebridge.rtp.RtpPacketizer;
import com.qht.voicebridge.rtp.RtpPortAllocator;
import com.qht.voicebridge.rtp.RtpSymmetricEndpoint;
import com.qht.voicebridge.service.CallCompletionService;
import com.qht.voicebridge.service.CrmCustomerService;
import com.qht.voicebridge.service.DspService;
import com.qht.voicebridge.service.StasisAppConfigService;
import com.qht.voicebridge.session.CallSession;
import com.qht.voicebridge.session.CallSessionManager;
...
public class AriBridgeImpl {
  ...
  private void startRtpAndAi(String channelId, StasisAppConfig p, GraphReady graph) {
    ...
    try {
      ...
      if(p.getBarinEnabled()) {
		   ...
		   s.setBargeController(new com.qht.voicebridge.barge.BargeInController(
		       codecRate,
		       startupIgnoreMs,
		       cooldownMs,
		       confirmMs,
  ...
  private void fetchAndStoreCustomerInfoBlocking(CallSession s, StasisAppConfig cfg) {
    ...
    try {
      ...
      com.qht.voicebridge.service.dto.CrmCustomerDto dto =
          crmCustomerService
  ...
  private String toCompactCustomerInfoString(com.qht.voicebridge.service.dto.CrmCustomerDto dto) {
