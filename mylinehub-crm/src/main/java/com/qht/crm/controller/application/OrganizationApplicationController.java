package com.qht.crm.controller.application;

import static com.qht.crm.controller.ApiMapping.Organization_App_REST_URL;
...
import com.qht.crm.gst.api.cloud.wrapper.OkHttpSendIdfyTaskProcessorAdvanceGST;
import com.qht.crm.gst.api.cloud.wrapper.OkHttpSendVueAdvanceGstClient;
import com.qht.crm.gst.api.cloud.wrapper.OkHttpSendVueAuthClient;
import com.qht.crm.gst.data.GSTVerificationEngineData;
import com.qht.crm.gst.data.TokenData;
import com.qht.crm.gst.data.dto.GstVerificationEngineDataParameterDto;
import com.qht.crm.gst.data.dto.TokenDataDto;
import com.qht.crm.gst.data.dto.TokenDataParameterDto;
...
import com.qht.crm.gst.repository.RegisterGstErrorsRepository;
import com.qht.crm.gst.repository.RegisterGstRepository;
import com.qht.crm.repository.UsedRegistrationTokenRepository;
import com.qht.crm.service.MenuService;
...
//                				throw new Exception("Not Registered! Technical Issue. Token not found for engine : "+tokenDataParameterDto.getEngine()+". WhatsApp "+parentPhoneNumber+" for support.");
    ...
    public ResponseEntity<String> createOrgFromBackendWithoutGST(@RequestBody UpdateOrgDTO updateOrgDTO) throws Exception {
        ...
        try {
        	...
        	if(updateOrgDTO.getToken().equals("QHT100010001")) {	
