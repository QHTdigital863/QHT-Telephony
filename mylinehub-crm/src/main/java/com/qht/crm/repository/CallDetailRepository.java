...
public interface CallDetailRepository extends JpaRepository<CallDetail, Long> {
    ...
    @Query("select new com.qht.crm.entity.dto.CallCountForEmployeeDTO(COUNT(e.id)) " +
           "from CallDetail e " +
    ...
    @Query("select new com.qht.crm.entity.dto.CallCountByCallTypeDTO(e.callType,COUNT(e.id)) " +
           "from CallDetail e " +
           "where e.startdate >= ?1 and e.startdate <= ?2 and e.organization = ?3 and " +
           "(e.callerid LIKE %?4% or e.employeeName LIKE %?4% or e.customerName LIKE %?4% or e.customerid LIKE %?4% or e.phoneContext LIKE %?4% or e.country LIKE %?4%) " +
    ...
    @Query("select new com.qht.crm.entity.dto.CallCountForEmployeeDTO(e.callerid,COUNT(e.callerid)) " +
           "from CallDetail e " +
           "where e.startdate >= ?1 and e.startdate <= ?2 and e.organization = ?3 and " +
           "(e.callerid LIKE %?4% or e.employeeName LIKE %?4% or e.customerName LIKE %?4% or e.customerid LIKE %?4% or e.phoneContext LIKE %?4% or e.callType LIKE %?4% or e.country LIKE %?4%) " +
    ...
    @Query("select new com.qht.crm.entity.dto.CallCountForEmployeeDTO(e.callerid,COUNT(e.callerid), MONTH(e.startdate), YEAR(e.startdate)) " +
           "from CallDetail e " +
           "where e.startdate >= ?1 and e.startdate <= ?2 and e.organization = ?3 and " +
           "(e.callerid LIKE %?4% or e.employeeName LIKE %?4% or e.customerName LIKE %?4% or e.customerid LIKE %?4% or e.phoneContext LIKE %?4% or e.callType LIKE %?4% or e.country LIKE %?4%) " +
