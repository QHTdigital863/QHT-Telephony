...
import com.qht.crm.entity.AmiConnection;
import com.qht.crm.entity.Conference;
import com.qht.crm.entity.Departments;
...
import com.qht.crm.entity.Queue;
import com.qht.crm.entity.SshConnection;
import com.qht.crm.entity.dto.BulkUploadEmployeeDto;
import com.qht.crm.entity.dto.EmployeeDataAndStateDTO;
import com.qht.crm.entity.dto.UpdateOrgDTO;
import com.qht.crm.enums.COST_CALCULATION;
import com.qht.crm.enums.PRI_LINE_TYPE;
import com.qht.crm.enums.USER_ROLE;
import com.qht.crm.exports.excel.BulkUploadEmployeeToDatabase;
import com.qht.crm.mapper.OrganizationMapper;
import com.qht.crm.rag.enums.ParentPromptType;
import com.qht.crm.rag.enums.PromptType;
import com.qht.crm.rag.service.AssistantService;
import com.qht.crm.rag.service.PromptBuilderHeuristicAndEnglishLanguageConvertorService;
import com.qht.crm.rag.service.PromptBuilderSummarizeService;
import com.qht.crm.rag.service.PromptBuilderWhatsAppBotService;
import com.qht.crm.rag.service.SystemPromptService;
import com.qht.crm.repository.AmiConnectionRepository;
import com.qht.crm.repository.ConferenceRepository;
import com.qht.crm.repository.DepartmentsRepository;
import com.qht.crm.repository.EmployeeRepository;
import com.qht.crm.repository.IvrRepository;
import com.qht.crm.repository.OrganizationRepository;
import com.qht.crm.repository.ProductRepository;
import com.qht.crm.repository.QueueRepository;
import com.qht.crm.repository.SshConnectionRepository;
import com.qht.crm.security.CryptoUtils;
import com.qht.crm.whatsapp.dto.WhatsAppOpenAiAccountDto;
import com.qht.crm.whatsapp.dto.WhatsAppPhoneNumberDto;
import com.qht.crm.whatsapp.dto.WhatsAppPhoneNumberTemplateDto;
import com.qht.crm.whatsapp.dto.WhatsAppPhoneNumberTemplateVariableDto;
...
import com.qht.crm.whatsapp.enums.COMPONENT_TYPE;
import com.qht.crm.whatsapp.enums.TEMPLATE_VARIABLES;
import com.qht.crm.whatsapp.enums.TEMPLATE_VARIALE_TYPE;
import com.qht.crm.whatsapp.enums.chat.CONVERSATION_TYPE;
import com.qht.crm.whatsapp.service.CreateFileCategoryForOrgService;
import com.qht.crm.whatsapp.service.WhatsAppNumberTemplateVariableService;
import com.qht.crm.whatsapp.service.WhatsAppOpenAiAccountService;
...
import com.qht.crm.whatsapp.service.WhatsAppProjectService;
    ...
    public Employee createInitialDataForOrg(UpdateOrgDTO updateOrgDTO, Organization organization,String parentPhoneNumber) throws Exception {
        ...
        try {
    		...
    		if (allEmployeeDataAndStateMap == null || allEmployeeDataAndStateMap.size() <= 10) {
    		    System.out.println("[DEBUG] First user registration, root qht user. Extension set to: 10000001");
    		    lastUsedRegistrationExtension = 9999991;
    		    newEmployee.setExtension("10000001");
    		    newEmployee.setExtensionpassword("qht@10000001");
    		    ...
    		    newEmployee.setExtensionpassword("qht@11000001");
    		} else {
    		    ...
    		    newEmployee.setExtensionpassword("qht@" + lastUsedRegistrationExtension);
    		}
