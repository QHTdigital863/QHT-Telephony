...
public class SystemConfig {
    ...
    @Column(columnDefinition = "varchar(255) default 'QHT'")
    String organization;
    ...
    int smtpport;
    @Column(columnDefinition = "varchar(255) default 'support@qht.com'")
    String smtpusername;
    ...
    @Column(columnDefinition = "varchar(255) default 'qht_onboarding'")
    String onboardingTemplate;
    @Column(columnDefinition = "varchar(255) default 'qht_low_funds'")
