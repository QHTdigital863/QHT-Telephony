/*
 * File: src/main/java/com/qht/voicebridge/models/StasisAppConfig.java
 *
 * Purpose:
...
package com.qht.voicebridge.models;
...
public class StasisAppConfig {
  ...
  // QHT ORG / AUTH
  // =========================
  @Column(name = "qht_login_url", length = 512)
  private String qht_login_url;

  @Column(name = "qht_login_username", length = 256)
  private String qht_login_username;

  @Column(name = "qht_login_password", length = 256)
  private String qht_login_password;

  @Column(name = "qht_org_lookup_url", length = 512)
  private String qht_org_lookup_url;

  @Column(name = "qht_base_url", length = 512)
  private String qht_base_url;

  @Column(name = "qht_crm_cdr_url", length = 512)
  private String qht_crm_cdr_url;

  @Column(name = "qht_crm_customer_get_by_phone_url", length = 512)
  private String qht_crm_customer_get_by_phone_url;

  @Column(name = "qht_crm_customer_update_by_org_url", length = 512)
  private String qht_crm_customer_update_by_org_url;
  
  @Column(name = "qht_crm_deduct_ai_amount_url", length = 512)
  private String qht_crm_deduct_ai_amount_url;
