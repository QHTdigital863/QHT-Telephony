package com.qht.crm.security.email;
...
public class EmailBuilder {
    ...
    public static String buildWelcomeEmail() {
        return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" + 
        		...
        		"  </head>\n" + 
        		"  <body>\n" + 
        		"    <span class=\"preheader\">Thanks for trying out QHT Clinic. We’ve pulled together some information and resources to help you get started.</span>\n" + 
        		...
        		"                <a href=\"https://www.qht.com/home/how-it-works/\" class=\"f-fallback email-masthead_name\">\n" + 
        		"                QHT Clinic\n" + 
        		"              </a>\n" + 
        		"              </td>\n" + 
        		"            </tr>\n" + 
        		...
        		"                        <h1>Welcome, {{name}}!</h1>\n" + 
        		"                        <p>Thanks for trying QHT Clinic. We’re thrilled to have you on board. To get the most out of QHT Clinic, do this primary next step:</p>\n" + 
        		"                        <!-- Action -->\n" + 
        		...
        		"                              <p class=\"f-fallback sub\">https://www.qht.com/</p>\n" + 
        		"                            </td>\n" + 
        		"                          </tr>\n" + 
        		"                        </table>\n" + 
        		"                      </div>\n" + 
    ...
    public static String buildPasswordEmail() {
        return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" + 
        		...
        		"            <tr>\n" + 
        		"              <td class=\"email-masthead\">\n" + 
        		"                <a href=\"https://qht.com\" class=\"f-fallback email-masthead_name\">\n" + 
        		"                QHT Clinic\n" + 
        		"              </a>\n" + 
        		"              </td>\n" + 
        		"            </tr>\n" + 
    ...
    public static String buildRechargeDoneEmail(String amount, String organization) {
   	 return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "      <td style=\"font-family:Helvetica,Arial,sans-serif;font-size:19px;line-height:1.315789474;max-width:560px\">\n" +
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + organization + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Your Organization recharge for QHT Clinic CRM is successful of amount : "+amount+". </p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
    ...
    public static String buildLowFundEmail(String organization) {
      	 return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                   ...
                   "      <td style=\"font-family:Helvetica,Arial,sans-serif;font-size:19px;line-height:1.315789474;max-width:560px\">\n" +
                   "        \n" +
                   "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + organization + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Your Organization is low on fund with QHT Clinic CRM. Kindly recharge. </p>" +
                   "        \n" +
                   "      </td>\n" +
                   "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                   "    </tr>\n" +
    ...
    public static String buildAccountDeactivatedEmail(String organization) {
     	 return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                  ...
                  "      <td style=\"font-family:Helvetica,Arial,sans-serif;font-size:19px;line-height:1.315789474;max-width:560px\">\n" +
                  "        \n" +
                  "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + organization + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Your Organization account with qht has been deactivated due to low funds for more than 30 days. </p>" +
                  "        \n" +
                  "      </td>\n" +
                  "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                  "    </tr>\n" +
