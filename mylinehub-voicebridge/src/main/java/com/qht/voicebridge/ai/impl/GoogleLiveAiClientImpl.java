 ...
 * File: src/main/java/com/qht/voicebridge/ai/impl/GoogleLiveAiClientImpl.java
 *
...
package com.qht.voicebridge.ai.impl;
...
import com.qht.voicebridge.ai.RealtimeAiClient;
import com.qht.voicebridge.audio.AlignedPcmChunker;
...
import com.qht.voicebridge.queue.OutboundQueue;
import com.qht.voicebridge.service.RagService;
import com.qht.voicebridge.service.StasisAppConfigService;
import com.qht.voicebridge.service.impl.CrmCustomerServiceImpl;
import com.qht.voicebridge.session.CallSession;
import com.qht.voicebridge.session.CallSessionManager;
import com.qht.voicebridge.util.OkHttpLoggerUtils;
    ...
    private void sendInitialGreeting(WebSocket ws) {
        ...
        try {
            ...
            parts.addObject().put("text",
                    "Start the phone conversation now with your standard QHT Clinic greeting and ask for the caller's requirement.");
