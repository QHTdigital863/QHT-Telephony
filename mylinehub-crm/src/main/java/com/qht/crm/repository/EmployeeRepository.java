...
import com.qht.crm.requests.ImageSizeSummaryRequest;
...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("select  new com.qht.crm.entity.Employee(e.id,e.firstName, e.lastName, e.email, e.userRole , e.pesel, e.birthdate , e.department,e.extension, e.phonenumber, e.imageType,e.iconImageData) from Employee e where e.extension in (?1) and e.organization = ?2")
