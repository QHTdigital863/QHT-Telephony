...
public static readonly PROTOCOL: string = 'http://';
public static readonly SERVER_IP: string = 'localhost';
public readonly API_BASE_ENDPOINT: string = environment.apiBaseUrl;
...
//Web Socket
public static webSocketEndPoint:any = environment.wsSockUrl;
...
public readonly searchPosts : any [] = [
  {
    ...
    "text": "Looking out to find who all were absent today or few days back. Check out our ansenteeism module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "AMI Connections",
    "link": this.AMI_REGISTRIES_ENDPOINT,
    "text": "Looking out to find how we connect with your asterisk server. It is done via AMI Connections. Check out asterisk manual to know more about this. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Call Details",
    "link": this.All_Call_DETAIL_ENDPOINT,
    "text": "Looking out to find all call details across your organization. Check out our call details module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Calling Costs",
    "link": this.All_COST_DETAIL_ENDPOINT,
    "text": "Looking out to find all calling costs across your organization. Check out our calling cost module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Campaigns",
    "link": this.All_CAMPAIGN_DETAIL_ENDPOINT,
    "text": "Looking out to setup autodialer. It can be done by setting up campaigns. Check out our campaign module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Conferences",
    "link": this.All_CONFERENCE_DETAIL_ENDPOINT,
    "text": "For management we can setup personal conferences. This extension is static and may be protected by passwords. Check out our conference module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Customers",
    "link": this.All_CUSTOMER_DETAIL_ENDPOINT,
    "text": "Find details & reports for your customers. Verify if they got converted or diverted. Check what type of business they own. Check out our customer module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Departments",
    "link": this.All_DEPARTMENT_DETAIL_ENDPOINT,
    "text": "Maintain different departmentss your organization own. Check out our department module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Employee Profile",
    "link": this.PROFILE_ENDPOINT,
    "text": "Check out profile for your account. This is to update self information. Although a manager can update details of employee but this has to be done at different link. Check out our employee module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Errors",
    "link": this.All_ERROR_DETAIL_ENDPOINT,
    "text": "Check out errors within application. Check out our error module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "IVR",
    "link": this.All_IVR_DETAIL_ENDPOINT,
    "text": "Interactive voice response. Automate them with QHT Clinic. It can be done using campaign module. But what IVR to execute, this information will need to be here. Check out our IVR module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Logs",
    "link": this.All_LOG_DETAIL_ENDPOINT,
    "text": "Check out logs within application. Check out our log module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Products",
    "link": this.All_PRODUCT_DETAIL_ENDPOINT,
    "text": "Maintain your products within QHT Clinic tool. Check out our product module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Purchases",
    "link": this.All_PURCHASE_DETAIL_ENDPOINT,
    "text": "Maintain your purchases within QHT Clinic tool. Check out our purchase module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Queues",
    "link": this.All_QUEUE_DETAIL_ENDPOINT,
    "text": "'Ringall', 'Round Robin'. We own capability to produce queues with different strategies or custom requirements for your team. Automate calling them with QHT Clinic. It can be done using campaign module. But what Queue to execute, this information will need to be here. Check out our IVR module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "SIP Providers",
    "link": this.All_SIP_PROVIDER_DETAIL_ENDPOINT,
    "text": "Looking out to find phone numbers associated to your employees. Check out our sip provider module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "SSH Connections",
    "link": this.All_SSH_PROVIDER_DETAIL_ENDPOINT,
    "text": "This is how we extract employee call recordings from asterisk server. Check out our ssh connection module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
  {
    "title": "Suppliers",
    "link": this.All_SUPPLIER_DETAIL_ENDPOINT,
    "text": "Maintain your suppliers within QHT Clinic tool. Check out our supplier module for this purpose. In case this does not resolve this issues get in touch with our team at QHT Clinic"
  },
];
