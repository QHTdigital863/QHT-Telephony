...
import com.qht.voicebridge.util.SystemJwtTokenHolder;
...
//    private final StasisAppConfigService configService;
    ...
    private Mono<String> login(StasisAppConfig cfg, String stasisAppName) {
        ...
        String loginPath = cfg.getQht_login_url();
        String username  = cfg.getQht_login_username();
        String password  = cfg.getQht_login_password();
