 ...
 *
 * Builds the full system prompt for the WhatsApp QHT Clinic assistant.
 */
@Service
public class PromptBuilderWhatsAppBotService {
    ...
    public String buildPrompt(String organization, String orgServices) {
    	...
    	String salesAssistantPrompt =
    	        ...
    	        "// VIDEOS / DEMOS\\n" +
    	        "If user asks for demo/tutorial, include max two links from QHTVIDEOS YouTube or input. " +
