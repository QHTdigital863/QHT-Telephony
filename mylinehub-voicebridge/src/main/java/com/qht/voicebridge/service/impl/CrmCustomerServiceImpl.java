 ...
 *   src/main/java/com/qht/voicebridge/service/impl/CrmCustomerServiceImpl.java
 *
...
public class CrmCustomerServiceImpl implements CrmCustomerService {
    ...
    public Mono<CrmCustomerDto> getByPhoneNumberAndOrganization(String stasisAppName,
        ...
        String path = cfg.getQht_crm_customer_get_by_phone_url();
    ...
    public Mono<Boolean> updateCustomerByOrganization(String stasisAppName,
        ...
        String baseUrl = cfg.getQht_base_url();
        String path = cfg.getQht_crm_customer_update_by_org_url();
        if (isBlank(baseUrl) || isBlank(path)) {
