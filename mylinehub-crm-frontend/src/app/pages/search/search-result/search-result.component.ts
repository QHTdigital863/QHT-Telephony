  ...
  // console.log(JSON.stringify(this.searchCard.news));
   ...
   // console.log("value is undefined");
      ...
      this.searchCard.news =[
        {
          "title": "No data found",
          "link": "https://QHT Clinic",
          "text": "No result found. Try to search some other string In case this does not resolve this issues get in touch with our team at QHT Clinic"
        },
      ];
   }
   ...
   /*  if(this.noElement)
     {
        ...
        cardData.news.push(
         [{
            ...
            "link": "https://QHT Clinic",
            "text": "The text you searched for was not found. Please try searcgning for related words. Or else please reach out to QHT Clinic administration team for support."
          }]);
