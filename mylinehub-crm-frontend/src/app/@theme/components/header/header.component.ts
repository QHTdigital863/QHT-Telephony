  ...
  setMenuData()
  {
    ...
    .subscribe({
      ...
      //  console.log("getOrganizationalData");
        ...
        // Fall back to the full menu when the org has no menuAccess configured (e.g. local/single-tenant setup)
        this.menuDataService.menu = (menu && menu.length > 0) ? menu : MENU_ITEMS;
