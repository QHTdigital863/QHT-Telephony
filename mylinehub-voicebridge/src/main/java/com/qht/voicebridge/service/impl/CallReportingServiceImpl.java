...
import com.qht.voicebridge.crm.dto.CdrDTO;
import com.qht.voicebridge.crm.mapper.CallSessionToCdrDTO;
...
import com.qht.voicebridge.service.CallReportingService;
import com.qht.voicebridge.service.LoginService;
 ...
 *  - Sends CDRDTO to QHT Clinic CRM API (per stasis-app, DB driven)
 */
@Slf4j
@Service
...
public class CallReportingServiceImpl implements CallReportingService {
    ...
    public void reportCall(CallSession session, CallBillingInfo info) {
        ...
        String baseUrl = cfg.getQht_base_url();
        String path    = cfg.getQht_crm_cdr_url();
